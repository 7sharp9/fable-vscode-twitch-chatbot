...
module Vscode =
    ...
    type [<AllowNullLiteral>] TextEditorSelectionChangeEvent =
        ...
        abstract selections: ReadonlyArray<Selection>
    ...
    type [<AllowNullLiteral>] TextEditorVisibleRangesChangeEvent =
        ...
        abstract visibleRanges: ReadonlyArray<Range>
    ...
    type [<AllowNullLiteral>] ThemeIconStatic =
        ...
        /// <param name="id">id of the icon. The avaiable icons are listed in https://microsoft.github.io/vscode-codicons/dist/codicon.html.</param>
    ...
    type [<AllowNullLiteral>] CodeActionContext =
        ...
        abstract diagnostics: ReadonlyArray<Diagnostic>
    ...
    type [<AllowNullLiteral>] MarkdownString =
        ...
        /// <summary>Appends the given string 'as is' to this markdown string. When [`supportThemeIcons`](#MarkdownString.supportThemeIcons) is `true`, [ThemeIcons](#ThemeIcon) in the `value` will be iconified.</summary>
    ...
    type [<AllowNullLiteral>] MarkdownStringStatic =
        ...
        /// <param name="supportThemeIcons">Optional, Specifies whether [ThemeIcons](#ThemeIcon) are supported within the [`MarkdownString`](#MarkdownString).</param>
    ...
    type [<AllowNullLiteral>] CompletionItemProvider =
        ...
        /// be changed when resolving an item.</summary>
    ...
    type [<AllowNullLiteral>] WorkspaceConfiguration =
        ...
        /// otherwise to [Workspace settings](#ConfigurationTarget.Workspace).</param>
    ...
    type [<AllowNullLiteral>] DiagnosticChangeEvent =
        ...
        abstract uris: ReadonlyArray<Uri>
    ...
    type [<AllowNullLiteral>] CustomExecutionStatic =
        /// <summary>Constructs a CustomExecution task object. The callback will be executed the task is run, at which point the
        /// extension should return the Pseudoterminal it will "run in". The task should wait to do further execution until
        /// [Pseudoterminal.open](#Pseudoterminal.open) is called. Task cancellation should be handled using
        /// [Pseudoterminal.close](#Pseudoterminal.close). When the task is complete fire
        /// [Pseudoterminal.onDidClose](#Pseudoterminal.onDidClose).</summary>
        /// <param name="callback">The callback that will be called when the task is started by a user.</param>
        [<Emit "new $0($1...)">] abstract Create: callback: (unit -> Thenable<Pseudoterminal>) -> CustomExecution
    ...
    type [<AllowNullLiteral>] Webview =
        ...
        /// <param name="message">Body of the message. This must be a string or other json serilizable object.</param>
    ...
    module Commands =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract executeCommand: command: string * [<ParamArray>] rest: ResizeArray<obj option> -> Promise<'T option>
    ...
    module Window =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <summary>Creates a [Terminal](#Terminal) with a backing shell process. The cwd of the terminal will be the workspace
            ...
            /// <summary>Creates a [Terminal](#Terminal) with a backing shell process.</summary>
            ...
            /// <summary>Creates a [Terminal](#Terminal) where an extension controls its input and output.</summary>
            /// <param name="options">An [ExtensionTerminalOptions](#ExtensionTerminalOptions) object describing
    ...
    type [<AllowNullLiteral>] Pseudoterminal =
        ...
        /// <param name="data">The incoming data.
        /// 
    ...
    type [<AllowNullLiteral>] TextDocumentChangeEvent =
        ...
        abstract contentChanges: ReadonlyArray<TextDocumentContentChangeEvent>
    ...
    type [<AllowNullLiteral>] FileWillCreateEvent =
        ...
        abstract files: ReadonlyArray<Uri>
        /// <summary>Allows to pause the event and to apply a [workspace edit](#WorkspaceEdit).
        /// 
        /// *Note:* This function can only be called during event dispatch and not
        /// in an asynchronous manner:
        /// 
    ...
    type [<AllowNullLiteral>] WorkspaceFoldersChangeEvent =
        ...
        abstract added: ReadonlyArray<WorkspaceFolder>
        /// Removed workspace folders.
        abstract removed: ReadonlyArray<WorkspaceFolder>
    ...
    module Workspace =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract workspaceFolders: ReadonlyArray<WorkspaceFolder> option
            ...
            abstract textDocuments: ReadonlyArray<TextDocument>
            ...
            /// 
            /// When a scope is provided configuraiton confined to that scope is returned. Scope can be a resource or a language identifier or both.</summary>
    ...
    type [<AllowNullLiteral>] ConfigurationChangeEvent =
        /// <summary>Returns `true` if the given section is affected in the provided scope.</summary>
        /// <param name="section">Configuration name, supports _dotted_ names.</param>
    ...
    type DebugAdapterDescriptor =
        U3<DebugAdapterExecutable, DebugAdapterServer, DebugAdapterInlineImplementation>
    ...
    type [<AllowNullLiteral>] BreakpointsChangeEvent =
        /// Added breakpoints.
        abstract added: ReadonlyArray<Breakpoint>
        /// Removed breakpoints.
        abstract removed: ReadonlyArray<Breakpoint>
        /// Changed breakpoints.
        abstract changed: ReadonlyArray<Breakpoint>
    ...
    module Debug =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <param name="parentSessionOrOptions">Debug sesison options. When passed a parent [debug session](#DebugSession), assumes options with just this parent session.</param>
    ...
    module Extensions =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract all: ReadonlyArray<Extension<obj option>>
    ...
    type [<AllowNullLiteral>] CommentController =
        ...
        abstract reactionHandler: (Comment -> CommentReaction -> Promise<unit>) option with get, set
